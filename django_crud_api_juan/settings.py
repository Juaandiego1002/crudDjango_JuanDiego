"""
Django settings for django_crud_api_juan project.
...
SECRET_KEY = 'django-insecure-h+p7nt-_6ho50p59g$^hbc@#9r0o1q)46yx)vwctwla#@jnr*g'
...
ROOT_URLCONF = 'django_crud_api_juan.urls'
...
WSGI_APPLICATION = 'django_crud_api_juan.wsgi.application'
